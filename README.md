...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-p14kpye.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-p14kpye.containers.anotherwebservice.com/
...
```
git clone git@github.com:AlexAwer34534/container-p14kpye.git
cd container-p14kpye
```
...
```
docker attach container-p14kpye
```
